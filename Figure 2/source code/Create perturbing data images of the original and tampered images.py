...
Step 1: You need to set the 'read_file_path_actual_image' parameter to the absolute path of the original image
Step 2: You need to set the parameter 'read_file_path_adversarial_sample' to the absolute path of the adversarial sample
...
save_file_path = ".//perturbation information.png"
