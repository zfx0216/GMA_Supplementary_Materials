...
actual_image_absolute_path = "D:\pycharmBao\pythonProject2\Transferable_adversarial_samples_official\白盒攻击\\1654 Supplementary materials\Figure 3\(a) original image X.png"
...
image_high_frequency_information_R = High_pass_filter(actual_image_channel_R)
image_high_frequency_information_G = High_pass_filter(actual_image_channel_G)
image_high_frequency_information_B = High_pass_filter(actual_image_channel_B)

# Combine three channels into an RGB image
image_rgb = image_high_frequency_information_R
# Convert data type to 8-bit unsigned integer
image_rgb = image_rgb.astype(np.uint8)
# Create PIL image object
image_pil = Image.fromarray(image_rgb)
image_pil.save("R_channel amplitude image.png")


# Combine three channels into an RGB image
image_rgb = image_high_frequency_information_G
# Convert data type to 8-bit unsigned integer
image_rgb = image_rgb.astype(np.uint8)
# Create PIL image object
image_pil = Image.fromarray(image_rgb)
image_pil.save("G_channel amplitude image.png")


# Combine three channels into an RGB image
image_rgb = image_high_frequency_information_B
# Convert data type to 8-bit unsigned integer
image_rgb = image_rgb.astype(np.uint8)
# Create PIL image object
image_pil = Image.fromarray(image_rgb)
image_pil.save("B_channel amplitude image.png")
